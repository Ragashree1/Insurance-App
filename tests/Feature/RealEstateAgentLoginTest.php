...
class RealEstateAgentLoginTest extends TestCase
{
    use RefreshDatabase;
    ...
    public function test_real_estate_agent_can_log_in(): void
    {
        ...
        // real estate agent will be redirected to main page (dashboard) upon successful login
        $response->assertRedirect('/dashboard');
    }

    public function test_real_estate_agent_cannot_login_with_incorrect_credentials(): void
    {
    ...
    public function test_real_estate_agent_cannot_login_without_password(): void
    {
        $user = User::factory()->create(['user_profile_id' => '4', 'password' => self::PASS]);
