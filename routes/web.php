...
Route::get('/calculate-mortgage', function () { return view('CalculateMortgage'); })->name('mortgage');
Route::post('/calculate-mortgage', [MortgageController::class, 'calculate'])->name('calculate-mortgage');